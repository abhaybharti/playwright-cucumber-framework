export class RegistrationPageLocators {
  ...
  static getFieldSelectorByLabel(label: string): string {
    switch (label.toLowerCase()) {
      case 'first name': return this.FIRST_NAME;
      case 'last name': return this.LAST_NAME;
      case 'address': return this.ADDRESS;
      case 'city': return this.CITY;
      case 'state': return this.STATE;
      case 'zip code': return this.ZIP_CODE;
      case 'phone number': return this.PHONE;
      case 'social security number': return this.SSN;
      case 'username': return this.USERNAME;
      case 'password': return this.PASSWORD;
      case 'confirm password': return this.CONFIRM_PASSWORD;
      default: throw new Error(`Unknown field label: ${label}`);
    }
  }
}